...
namespace Cookie
{
    ...
    namespace Errors
    {
        public enum CookieErrorKind : uint
        {
    ...
    public partial class CookieClient : TransactionalBaseClient<CookieErrorKind>
    {
        public CookieClient(IRpcClient rpcClient, IStreamingRpcClient streamingRpcClient, PublicKey programId) : base(rpcClient, streamingRpcClient, programId)
        {
        }
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.CookieProgram.InitPlayer(accounts, levelSeed, programId);
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.CookieProgram.ChopTree(accounts, levelSeed, counter, programId);
            return await SignAndSendTransaction(instr, feePayer, signingCallback);
        }
        ...
        {
            Solana.Unity.Rpc.Models.TransactionInstruction instr = Program.CookieProgram.SuperChopTree(accounts, levelSeed, counter, programId);
            return await SignAndSendTransaction(instr, feePayer, signingCallback);
        }

        protected override Dictionary<uint, ProgramError<CookieErrorKind>> BuildErrorsDictionary()
        {
            return new Dictionary<uint, ProgramError<CookieErrorKind>>{{6000U, new ProgramError<CookieErrorKind>(CookieErrorKind.NotEnoughEnergy, "Not enough energy")}, {6001U, new ProgramError<CookieErrorKind>(CookieErrorKind.WrongAuthority, "Wrong Authority")}, };
        }
    }
    ...
    namespace Program
    {
        ...
        public static class CookieProgram
        {
